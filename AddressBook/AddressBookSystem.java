...
public class AddressBookSystem {
    ...
    public static void main(String[] args) {
        welcome();
        Contact details = new Contact("mallepogu", "Alankritha", "S.rnagar, b.kguda", "Hyderabad",
                                "Telangana", "mallepogualankritha@gmail.com", 500062, 71232999888L);
        System.out.println("The  contact details are mentioned below : \n");
